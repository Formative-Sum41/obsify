...
Open a private security advisory on the repository (or email the maintainer). Please do not
file public issues for exploitable sandbox escapes until a fix is available.
